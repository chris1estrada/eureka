...
INSERT INTO `business_users` VALUES (44),(50),(51),(53),(55),(56),(57),(87),(93);
...
BEGIN
	...
	IF(filter1 IS NOT NULL AND filter2 IS NOT NULL) THEN
		SELECT
			b.business_id, b.name, b.address, b.cuisine, if(is_open(b.business_id), 'true', 'false') as 'open', b.lat, b.long, get_image(b.business_id),
            (3959 * acos (
			cos ( radians( uLat ) )
			* cos( radians( `lat` ) )
...
-- Dump completed on 2020-04-09 13:55:16
